...
⚠️ 중요: 매수가/목표가/손절가는 반드시 위 데이터에 명시된 현재가 기준으로 계산하세요.
절대로 학습 데이터나 과거 가격을 사용하지 마세요.
...
{{
  ...
  "추천종목": [
    {{
      ...
      "티커": "티커",
      "전략": "단타|스윙|중장기 중 하나",
      "매수가": "현재가 기준 매수 진입가 (예: 444,500원)",
      "목표가": "매수가 대비 목표 익절가 (예: 467,000원)",
      "손절가": "매수가 대비 손절가 (예: 431,000원)",
      "예상수익률": "X~X%",
